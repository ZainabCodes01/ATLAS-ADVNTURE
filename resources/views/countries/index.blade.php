...
<h1>Countries</h1><br><br>
    <a style="background-color:#0C243C; color:#C9D1D5"  href="{{ route('countries.create') }}" class="rounded btn mb-1">Create Countries</a>
        ...
        <tbody>
            @foreach($countries as $countrie)
                <tr>
                    <td>{{ $countrie->id }}</td>
                    <td>{{ $countrie->name }}</td>
                    <td><img src="{{ $countrie->flag}}" alt="Flag Image" style="width: 250px; height: auto;">
                    </td>
